            ...
            <div className="footer">
                <div className="container">
                    <div className="col-md-3 footer-grid">
                        <h3>About Us</h3>
                        <p>This is Yerraguntla Harish. I am full stack developer . I am working on Nodejs,Express, mongoDB,& Reactjs since 1year .so, if you want make any kind of website/software please freely contact with us.</p>
                    </div>
                    <div className="col-md-3 footer-grid ">
                        <h3>Menu</h3>
                        <ul>
                    ...
                    <div className="footer-bottom">
                        ...
                        <p className="fo-para">This is Yerraguntla Harish. I am full stack developer . I am working on Nodejs,Express, mongoDB,& Reactjs since 1year .so, if you want make any kind of website/software please freely contact with us.</p>
                        ...
                        <div className=" address">
                            ...
                            <div className="col-md-4 fo-grid1">
                                <p><i className="fa fa-phone" aria-hidden="true" />+91 8790456900</p>
                            </div>
                            <div className="col-md-4 fo-grid1">
                                <p><Link to="/gmail.com"><i className="fa fa-envelope-o" aria-hidden="true" />harish861432@gmail.com</Link></p>
                            </div>
                            <div className="clearfix" />
                        </div>
                    </div>
                    <div className="copy-right">
                        <p> © 2020 Big store. All Rights Reserved | Design by Yerraguntla Harish</p>
                    </div>
                </div>
            </div>
