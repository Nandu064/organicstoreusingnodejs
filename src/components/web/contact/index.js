                        ...
                        <div className=" contact-w3">
                            ...
                            <div className="col-md-7 contact-left">
                                ...
                                <ul className="contact-list">
                                    <li> <i className="fa fa-map-marker" aria-hidden="true" /> Saket,Hyderabad, India.</li>
                                    <li><i className="fa fa-envelope" aria-hidden="true" /><Link to="/gmail.com">Harish861432@gmail.com</Link></li>
                                        ...
                                        <div className="resp-tabs-container hor_1">
                                            ...
                                            <div>
                                                <div className="map-grid">
                                                    <h5>Our Branches</h5>
                                                    <ul>
                                                        <li><i className="fa fa-arrow-right" aria-hidden="true" />Saket, Hyderabad, India.</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div>
                                                <div className="map-grid">
                                                    ...
                                                    <ul>
                                                        <li>Mobile No : +91 8790456900</li>
                                                        <li>Phone No : +91 8074696444</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
